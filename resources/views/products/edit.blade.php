...
<body>
    ...
    <div class="bg-dark py-3">
        <h1 class="text-white text-center">Product CRUD Application</h1>
    </div>
    <div class="container">
        <!-- Back Button Row -->
                ...
                <div class="card border-0 shadow-lg my-3">
                    ...
                    <form enctype="multipart/form-data" action="{{route('products.store')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Additional Product Images Input -->
                            <div class="mb-3">
                                <label for="product_images" class="form-label h5">Additional Images (optional)</label>
                                <input type="file" class="form-control form-control-lg" placeholder="Additional Images" name="product_images[]" multiple>
                            </div>
